    ...
    return(
        <React.Fragment>
            ...
            <div className={styles['sponsors-head']}>
                ...
                <span className={styles['sponsors-head__spanone-spantwo']}>year sponsors</span>
            </div>

            <div className={styles['sponsors-brands']}>
                <a href= "#"><img src={saucelabs} alt="saucelabs" /></a>
                <a href= "#"><img src={buf} alt="buf" /></a>
                <a href= "#"><img src={vue} alt="vue" /></a>
                <a href= "#"><img src={google} alt="google" /></a>
                <a href= "#"><img src={gold} alt="gold" /></a>
                <a href= "#"><img src={twilio} alt="twilio" /></a>
                <a href= "#"><img src={superblocks} alt="superblocks" /></a>
                <a href= "#"><img src={ibm} alt="ibm" /></a>
                <a href= "#"><img src={bryntum} alt="bryntum" /></a>
                <a href= "#"><img src={kadena} alt="kadena" /></a>
            </div>
            </div>
        </React.Fragment>
    );
